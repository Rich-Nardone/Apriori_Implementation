...
if(dataset == 1):
    dataset = 'amazon_transactions.csv'
elif(dataset == 2):
    dataset = 'bestbuy_transactions.csv'
elif(dataset == 3):
    dataset = 'kmart_transactions.csv'
elif(dataset == 4):
    dataset = 'nike_transactions.csv'
elif(dataset == 5):
    dataset = 'espn_transactions.csv'
elif(dataset == 6):
    dataset = input('Please enter your CSV files name:')
